...
void SwapIntBytes( int *a ){
    unsigned char   b[8], c[8];
    int             i, si;
    si = sizeof(int);
    memcpy( b, a, si);
    for (i=0; i<si; ++i) c[i] = b[si-1-i];
    memcpy( a, c, si);
}
...
//	    (u_long) pic8, w,h,numcols,BitsPerPixel,ColorMapSize);
  ...
  if (comment && strlen(comment) > (size_t) 0){
    ...
    fwrite("G", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("I", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("F", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("8", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("9", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("a", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
  } else {
    ...
    fwrite("F", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("8", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("7", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
    fwrite("a", (size_t) 1, (size_t) 1, fp);    /* the GIF magic number */
  }
